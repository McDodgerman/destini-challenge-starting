...
//TODO: Step 8 - Create a method called getStory() that returns the first storyTitle from _storyData.
  String getStory() => _storyData[_sNum].title;

//TODO: Step 11 - Create a method called getChoice1() that returns the text for the first choice1 from _storyData.
  String getChoice1() => _storyData[_sNum].choice1;
//TODO: Step 12 - Create a method called getChoice2() that returns the text for the first choice2 from _storyData.
  String getChoice2() => _storyData[_sNum].choice2;
...
//TODO: Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  void nextStory(int cNum) {
    if (_sNum == 0 && cNum == 1) {
      _sNum = 2;
    } else if (_sNum == 0 && cNum == 2) {
      _sNum = 1;
    } else if (_sNum == 1 && cNum == 1) {
      _sNum = 2;
    } else if (_sNum == 1 && cNum == 2) {
      _sNum = 3;
    } else if (_sNum == 2 && cNum == 1) {
      _sNum = 5;
    } else if (_sNum == 2 && cNum == 2) {
      _sNum = 4;
    } else if (_sNum == 3 || _sNum == 4 || _sNum == 5) {
      restart();
    } else
